...
var instance = new Razorpay({
  key_id: 'rzp_test_0XwHNYH2apeIco',
...
module.exports={
    ...
    addToCart:(proId,userId)=>{
      ...
      return new Promise(async(resolve,reject)=>{
        ...
        if(userCart){
          let proExist=userCart.products.findIndex(product=> product.item==proId)  //Here we check thus the product ID is there in the array product array and returns the position of the element in the array
  ...
  removeCartProduct:(details)=>{
    ...
    placeOrder:(order,products,total)=>{
      return new Promise((resolve,reject)=>{
        ...
        db.get().collection(collection.ORDER_COLLECTION).insertOne(orderObj).then((response)=>{
          ...
          console.log("Orde Id: ",response.ops[0]._id);
    ...
    verifyPayment: (details) => {
      return new Promise((resolve, reject) => {
          ...
          let hmac = crypto.createHmac('sha256', 'K7I3i0AcxCK5juJShckxdlgK');
